...
// import 'package:speechandgesture_user/Task2Trial1.dart';
// import 'package:speechandgesture_user/Task3Trial1.dart';
import 'package:speechandgesture_user/demoTask1.dart';
import 'package:speechandgesture_user/userTask3.dart';
// import 'package:speech_timestamp/googleAPI.dart';

class practiceContrastTask extends StatefulWidget{
  const practiceContrastTask({Key? key, required this.userID}) : super(key: key);
  final userID;
  @override
  _practiceContrastTask createState() => _practiceContrastTask(userID);
}
class _practiceContrastTask extends State<practiceContrastTask>{
  _practiceContrastTask(this.userID);
  final userID;
